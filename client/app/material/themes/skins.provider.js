function skinsProvider($mdThemingProvider, themesProvider) {
    "ngInject";
    var skins = {};
    ...
    return {
        skin: function (id, name) {
            ...
            var skin = new Skin(id, name, $mdThemingProvider, themesProvider);
...
function Skin(id, name, $mdThemingProvider, themesProvider) {
    "ngInject";
    ...
    self.loadThemes = function () {
        ...
        for (var element in self.elements) {
            ...
            var theme = themesProvider.theme(self.elements[element]);
...
function addSkinToScope($rootScope, skins) {
    "ngInject";
    $rootScope.triSkin = skins.getCurrent();
}
